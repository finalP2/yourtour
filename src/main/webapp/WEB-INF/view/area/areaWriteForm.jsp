        ...
        <button type="button" class="btn btn-default btn-lg" onclick="searchMap()">
         ...
         <br/>
         	<div class="control-group">
              ...
              <div class="controls">
                <input name="a_addr" class="form-control input" id="a_addr" type="text" placeholder="주소검색 버튼을 클릭 해주세요" readonly>
              </div>
            </div>
         <br/>
         	<div class="control-group">
         ...
         <br/>
            <div class="control-group">
              ...
              <div class="controls">
                <input name="a_way" class="form-control input" id="a_way" type="text" placeholder="ex) 2호선 삼성역 5번 출구로 나가서 도보로 5분">
              </div>
            </div>
         <br/>
         <div class="control-group">
              ...
              <div class="controls">
                <input name="a_hours" class="form-control input" id="a_hours" type="text" placeholder="ex) AM 07:00 ~ PM 9:00 연중무휴">
              </div>
            </div>
         <br/>
         <div class="control-group">
         ...
         <div class="control-group">
              ...
              <div class="controls">
                ...
                placeholder="ex) 압구정/청담에 이어 새로운 패션, 뷰티, 문화의 중심지 역할을 하고 있는 가로수길은 영동호텔 맞은편 부터 시작하여 압구정 현대고등학교 사이의 700m정도의 거리를 가로수길이라고..."></textarea>
              </div>
            </div>
         <br/>
         <div class="control-group">
