...
<form action="tipModifySuccess.go" class="form-horizontal" name="tForm" enctype="multipart/form-data" method="post">
...
<!-- 여행Tip 제목 -->
<div align="left">
	<b><font size="5" color="#266eb7"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>&nbsp;여행Tip 수정하기</font></b><br/>
...
<div align="left">
	<input type="file" onchange="previewImage(this,'previewId')" id="file" name="file" />
	<font color="red" size="2">*이미지를 다시 첨부하지 않으면 원본 이미지로 저장이 됩니다.</font>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input name="t_sub" class="form-control input" id="t_sub" type="text" value="${tipModel.t_sub}">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<textarea class="form-control" rows="5" id="comment" name="t_con" placeholder="Tip내용을 입력해주세요" >${tipModel.t_con }</textarea>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input name="a_name" class="form-control input" id="a_name" type="text" placeholder="주소검색 버튼을 클릭 해주세요" value="${tipModel.a_name}" readonly>
	</div>
</div>
...
<div align="right">
	...
	<button type="button" class="btn btn-default" onclick="tipList()">목록으로</button>
</div>
