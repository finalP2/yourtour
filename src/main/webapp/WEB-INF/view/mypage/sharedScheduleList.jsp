   ...
   <div class="panel-group" id="accordion" style="width: 80%; margin-left:5%;" >
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse1" class="panel-collapse collapse in">
        ...
        <div class="panel-body"><a href="/gokkiri/mypage/sharedScheduleList.go"><b>공유중인 일정</b></a></div>  
      </div>
    </div>
...
<h1 class="text-left">
<img src="/gokkiri/resources/img/sharedSchedule.png" />
</h1>
<br/>
...
<ul class="thumbnails" id="hover-cap-4col">
	<c:forEach var="sharedScheduleList" items="${sharedScheduleList }" varStatus="stat">
	<c:if test="${stat.index lt 8 }">
    <li class="col-md-3">
   		<font size="4" color="#266eb7"><b>#.&nbsp;${sharedScheduleList.s_name}&nbsp;</b></font>
        <div class="thumbnail">
            <div class="caption">
                <p><h5>≪&nbsp;${sharedScheduleList.s_start_date }박 ${sharedScheduleList.s_start_date + 1 }일 일정&nbsp;≫</h5></p>
                <p></p>
                <p>작성자 : ${sharedScheduleList.m_email }</p>
                <p>조회수 : ${sharedScheduleList.s_hit }</p>
                
                <p><a href="/gokkiri/schedule/scheduleDetail.go?s_no=${sharedScheduleList.s_no }&s_cate=0" class="btn btn-inverse" rel="tooltip" title="상세보기"><i class="glyphicon glyphicon-eye-open"></i></a> 
                    
                </p>
                
                <p><h4>${sharedScheduleList.s_detail_memo } 출발~</h4></p>
            </div>
            <!-- a_img_sav 컬럼을 s_together 컬럼명으로 바꿔서 불러옴↓↓↓ -->
            <img src="../resources/area_img/${sharedScheduleList.a_img_sav }" alt="ALT NAME" class="img-responsive"  style="max-width: 100%; height: 100%;" >
        </div>
	</li>
	</c:if>
	</c:forEach>
