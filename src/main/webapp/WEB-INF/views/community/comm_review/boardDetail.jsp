...
<body>
	...
	<script type="text/javascript">
		...
		function fn_openBoardUpdate(){
			var idx = "${map.IDX}";
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/comm/review/openBoardUpdate.go' />");
		...
		function fn_downloadFile(obj){
			...
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/comm/review/downloadFile.go' />");
			comSubmit.addParam("IDX", idx);
			comSubmit.submit();
		}
		...
		function fn_selectCommentList(pageNo){ //댓글리스트 json 으로 요청
			...
			comAjax.setUrl("<c:url value='/comm/review/selectCommentList.go' />");
