...
<body>
    <center>
        ...
        <form name="joinForm" method="post" action="join.go" onsubmit="return check();" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>이메일</td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>이메일 인증하기</td>
                    <td><input type="text" name="email2" readonly>
                    <input onclick="emailAuth(this.form)" name="confirmemail" type="button" value="인증확인"></button>
                    </td>
                </tr>
                ...
                <td>인증상태 </td>
				<td>
				<input type="text" name="mailCheck" placeholder="인증안함" readonly>                   
                </td>
                </tr>
