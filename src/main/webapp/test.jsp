...
<table width="85%" border="0" align="center">
		...
		<tr>
			<td colspan="3">
  				<a href="/yourtour/city/cityDetail.go?no=${cityModel.no}&keyword=${param.keyword}">홈</a>
				<a href="/yourtour/area/areaList.go?no=${areaModel.no }&keyword=${param.keyword}">여행지</a>
...
<img src="/yourtour/src/main/webapp/WEB-INF/views/img/main_img.jpg"/>
<table width="70%" align="center">
	<tr>
		<td>#설명</td>
